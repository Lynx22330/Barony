...
static double damagetables[NUMMONSTERS][7] =
{
	...
	{ 1.f, 1.f, 1.f, 1.f, 1.f, 0.8, 1.f }, // human
	{ 1.1, 1.1, 0.9, 0.8, 1.2, 0.8, 1.8 }, // rat
	{ 0.9, 1.f, 1.1, 1.1, 1.1, 0.8, 1.0 }, // goblin
	{ 1.5, 0.6, 1.5, 0.8, 0.6, 2.0, 0.8 }, // slime
	{ 1.4, 0.8, 1.1, 0.8, 0.9, 0.8, 0.8 }, // troll
	{ 1.2, 1.f, 1.1, 0.9, 1.1, 0.8, 1.f }, // octopus
	{ 1.f, 1.0, 1.f, 1.2, 1.1, 0.8, 1.1 }, // spider
	{ 1.f, 1.2, 0.8, 1.1, 0.8, 0.5, 1.1 }, // ghoul
	{ 0.5, 1.4, 0.8, 1.2, 0.7, 0.5, 1.1 }, // skeleton
	{ 0.9, 1.1, 1.f, 1.2, 1.f, 0.6, 1.2 }, // scorpion
	{ 1.1, 1.f, 0.8, 1.f, 1.f, 0.5, 1.f }, // imp
	{ 1.f, 1.0, 1.f, 1.2, 1.1, 0.8, 1.1 }, // crab
	{ 0.9, 1.f, 1.f, 0.9, 1.1, 0.6, 1.f }, // gnome
	{ 0.9, 0.8, 1.f, 0.8, 0.9, 0.5, 0.8 }, // demon
	{ 1.0, 1.2, 1.f, 0.9, 1.f, 0.8, 1.f }, // succubus
	{ 0.8, 1.1, 1.3, 1.f, 0.7, 1.2, 1.f }, // mimic
	{ 1.6, 1.6, 1.6, 1.6, 1.6, 0.8, 1.6 }, // lich
	{ 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7 }, // minotaur
	{ 2.f, 2.f, 2.f, 2.f, 1.f, 0.8, 1.f }, // devil
	{ 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7 }, // shopkeeper
	{ 1.3, 1.8, 1.3, 1.6, 1.3, 0.2, 1.8 }, // kobold
	{ 1.5, 1.1, 1.4, 0.7, 1.1, 0.3, 1.4 }, // scarab
	{ 1.2, 1.8, 1.2, 0.8, 0.8, 0.6, 0.6 }, // crystal golem
	{ 1.2, 1.f, 1.f, 0.7, 1.3, 0.8, 1.f }, // incubus
	{ 0.8, 1.2, 0.8, 1.1, 0.5, 0.8, 1.f }, // vampire
	{ 0.5, 0.5, 0.5, 0.5, 0.5, 2.0, 0.5 }, // shadow
	{ 1.6, 1.1, 1.3, 1.8, 0.7, 0.4, 0.8 }, // cockatrice
	{ 1.f, 0.7, 1.3, 1.3, 1.1, 0.8, 0.8 }, // insectoid
	{ 0.9, 1.f, 1.1, 1.1, 1.1, 1.2, 1.f }, // goatman
	{ 1.f, 1.4, 1.3, 1.f, 0.8, 0.8, 0.8 }, // automaton
	{ 1.2, 1.2, 1.2, 1.2, 1.2, 0.7, 1.0 }, // lich ice
	{ 1.2, 1.2, 1.2, 1.2, 1.2, 0.7, 1.0 }, // lich fire
	{ 1.f, 1.f, 1.f, 1.f, 0.5, 0.5, 1.f }, // sentrybot
	{ 1.f, 1.f, 1.f, 1.f, 0.5, 0.5, 1.f }, // sentrybot
	{ 1.f, 1.f, 1.f, 1.f, 0.5, 0.5, 1.f }, // gyrobot
	{ 1.f, 1.f, 1.f, 1.f, 0.6, 0.6, 0.6 }, // dummybot
	{ 0.9, 0.9, 0.9, 0.9, 1.5, 0.7, 0.8 }  // flyingrat
};
...
static std::vector<std::vector<unsigned int>> classStatGrowth =
{
	...
	{	8,	4,	3,	0,	4,	5 }, // BARBARIAN 0
	{	6,	2,	8,	1,	2,	5 }, // WARRIOR 1
	{	2,	2,	2,	8,	8,	2 }, // HEALER 2
	{	4,	8,	1,	2,	6,	3 }, // ROGUE 3
	{	5,	4,	5,	3,	5,	2 }, // WANDERER 4
	{	6,	3,	6,	3,	3,	3 }, // CLERIC 5
	{	3,	2,	4,	3,	5,	7 }, // MERCHANT 6
	{	0,	2,	2,	14,	3,	3 }, // WIZARD 7
	{	2,	6,	2,	6,	6,	2 }, // ARCANIST 8
	{	4,	4,	4,	4,	4,	4 }, // JOKER 9
	{	4,	4,	2,	6,	1,	1 }, // SEXTON 10
	{	6,	7,	0,	2,	7,	2 }, // NINJA 11
	{	6,	6,	6,	3,	3,	0 }, // MONK 12
	{	3,	4,	4,	8,	2,	2 }, // CONJURER 13
	{	2,	2,	1,	7,	7,	3 }, // ACCURSED 14
	{	1,	0,	1,	8,	5,	8 }, // MESMER 15
	{	4,	5,	5,	2,	3,	5 }, // BREWER 16
	{	2,	4,	2,	0, 12,	4 }, // MACHINIST 17
	{	5,	2,	1,	3,	5,	4 }, // PUNISHER 18
	{	7,	2,	6,	7,	2,	2 }, // SHAMAN 19
	{	0,	12,	4,	0,	6,	2 }  // HUNTER 20
};
