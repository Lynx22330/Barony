...
void initClassStats(const int classnum, void* myStats)
{
	...
	else if ( classnum == CLASS_WARRIOR )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_LEADERSHIP] = 35;
		...
		stat->PROFICIENCIES[PRO_RANGED] = -5;
		stat->PROFICIENCIES[PRO_TRADING] = -20;
	...
	else if (classnum == CLASS_HEALER)
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_SPELLCASTING] = 55;
		stat->PROFICIENCIES[PRO_MAGIC] = 30;
		stat->PROFICIENCIES[PRO_POLEARM] = 25;
		stat->PROFICIENCIES[PRO_ALCHEMY] = 30;
		stat->PROFICIENCIES[PRO_APPRAISAL] = 5;
		stat->PROFICIENCIES[PRO_SHIELD] = -25;
		stat->PROFICIENCIES[PRO_SWORD] = -10;
		stat->PROFICIENCIES[PRO_MACE] = -5;
	...
	else if ( classnum == CLASS_WANDERER )
	{
		...
		stat->PROFICIENCIES[PRO_POLEARM] = 35;
	...
	else if ( classnum == CLASS_WIZARD )
	{
		...
		stat->PROFICIENCIES[PRO_SPELLCASTING] = 65;
		stat->PROFICIENCIES[PRO_MAGIC] = 65;
		stat->PROFICIENCIES[PRO_ALCHEMY] = 5;
		stat->PROFICIENCIES[PRO_APPRAISAL] = 5;
		stat->PROFICIENCIES[PRO_TRADING] = 5;
		stat->PROFICIENCIES[PRO_UNARMED] = -25;
		stat->PROFICIENCIES[PRO_SWORD] = -25;
		stat->PROFICIENCIES[PRO_AXE] = -25;
		stat->PROFICIENCIES[PRO_MACE] = -25;
		stat->PROFICIENCIES[PRO_RANGED] = -35;
	}
	// arcanist
	else if ( classnum == CLASS_ARCANIST )
	{
		...
		stat->PROFICIENCIES[PRO_SWORD] = -15;
		stat->PROFICIENCIES[PRO_AXE] = -20;
	}
	// joker
	else if ( classnum == CLASS_JOKER )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_LOCKPICKING] = -7;
		stat->PROFICIENCIES[PRO_TRADING] = -7;
		stat->PROFICIENCIES[PRO_LEADERSHIP] = -7;
		stat->PROFICIENCIES[PRO_MAGIC] = -7;
		stat->PROFICIENCIES[PRO_SPELLCASTING] = -7;
		stat->PROFICIENCIES[PRO_ALCHEMY] = -7;
		stat->PROFICIENCIES[PRO_RANGED] = -7;
		stat->PROFICIENCIES[PRO_STEALTH] = -7;
		stat->PROFICIENCIES[PRO_UNARMED] = -7;
		stat->PROFICIENCIES[PRO_SWIMMING] = -7;
		stat->PROFICIENCIES[PRO_APPRAISAL] = -7;
	}
	// sexton
	...
	else if ( classnum == CLASS_NINJA )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_STEALTH] = 65;
		stat->PROFICIENCIES[PRO_SWORD] = 65;
		stat->PROFICIENCIES[PRO_RANGED] = -5;
		stat->PROFICIENCIES[PRO_SHIELD] = -30;
		stat->PROFICIENCIES[PRO_POLEARM] = -20;
		stat->PROFICIENCIES[PRO_MACE] = -20;
		stat->PROFICIENCIES[PRO_AXE] = -20;
	}
	// monk
	else if ( classnum == CLASS_MONK )
	{
		...
		stat->PROFICIENCIES[PRO_UNARMED] = 75;
		stat->PROFICIENCIES[PRO_ALCHEMY] = 25;
	...
	else if ( classnum == CLASS_CONJURER )
	{
		...
		stat->PROFICIENCIES[PRO_LOCKPICKING] = -20;
	}
	else if ( classnum == CLASS_ACCURSED )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_MAGIC] = 85;
		stat->PROFICIENCIES[PRO_SPELLCASTING] = 85;
	...
	else if ( classnum == CLASS_MESMER )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_MAGIC] = 35;
		stat->PROFICIENCIES[PRO_SPELLCASTING] = 45;
	...
	else if ( classnum == CLASS_HUNTER )
	{
		...
		stat->PROFICIENCIES[PRO_STEALTH] = 20;
		stat->PROFICIENCIES[PRO_SWIMMING] = 45;
		stat->PROFICIENCIES[PRO_RANGED] = 75;
		stat->PROFICIENCIES[PRO_SWORD] = -30;
		stat->PROFICIENCIES[PRO_MACE] = -30;
		stat->PROFICIENCIES[PRO_AXE] = -30;
		stat->PROFICIENCIES[PRO_POLEARM] = -30;
	}
	else if ( classnum == CLASS_MACHINIST )
	{
		...
		// skills
		stat->PROFICIENCIES[PRO_LOCKPICKING] = 50;
		stat->PROFICIENCIES[PRO_RANGED] = 25;
		stat->PROFICIENCIES[PRO_TRADING] = 35;
...
void initClass(const int player)
{
	...
	if ( client_classes[player] == CLASS_BARBARIAN )
	{
		...
		if ( isLocalPlayer )
		{
			...
			// booze
			item = newItem(POTION_BOOZE, EXCELLENT, 0, 2, 2, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
	...
	else if ( client_classes[player] == CLASS_CLERIC )
	{
		...
		if ( isLocalPlayer )
		{
			...
			// summon scrolls
			item = newItem(SCROLL_SUMMON, EXCELLENT, 1, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[4].item = item2->uid;
			free(item);
	...
	else if ( client_classes[player] == CLASS_WIZARD )
	{
		...
		// quarterstaff
		item = newItem(QUARTERSTAFF, EXCELLENT, 2, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		// wizard hat
		item = newItem(HAT_WIZARD, WORN, 0, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		// wizard doublet
		item = newItem(WIZARD_DOUBLET, WORN, 0, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		item = newItem(CLOAK_PROTECTION, WORN, 1, 1, 3, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		item = newItem(AMULET_MAGICREFLECTION, EXCELLENT, 1, 1, 1, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		if ( isLocalPlayer )
		{
			...
			item = newItem(SPELLBOOK_MAGICMISSILE, DECREPIT, -1, 1, 3, true, nullptr);
			item2 = itemPickup(player, item);
			if ( players[player]->hotbar.useHotbarFaceMenu )
			{
				hotbar[5].item = item2->uid;
			...
			item = newItem(SPELLBOOK_COLD, SERVICABLE, 2, 1, 3, true, nullptr);
			item2 = itemPickup(player, item);
			if (players[player]->hotbar.useHotbarFaceMenu)
			{
				hotbar[9].item = item2->uid;
			...
			// spellbook of light
			item = newItem(SPELLBOOK_LIGHT, SERVICABLE, 4, 1, 5, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
		}
	}
	...
	else if ( client_classes[player] == CLASS_ARCANIST )
	{
		...
		{
			// ammo
			item = newItem(QUIVER_FIRE, SERVICABLE, 0, 22, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[1].item = item2->uid;
			free(item);
	...
	else if ( client_classes[player] == CLASS_JOKER )
	{
		...
		{
			// slingshot
			item = newItem(SLING, EXCELLENT, 2, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[0].item = item2->uid;
			free(item);
			...
			item = newItem(SCROLL_TELEPORTATION, EXCELLENT, -1, 7, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[4].item = item2->uid;
			free(item);
			...
			// scroll of food
			item = newItem(SCROLL_FOOD, EXCELLENT, -7, 7, 0, false, nullptr);
			item2 = itemPickup(player, item);
			free(item);

			// ring of levitation
			item = newItem(RING_LEVITATION, EXCELLENT, 0, 1, 2, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
			...
			// food
			item = newItem(FOOD_CREAMPIE, EXCELLENT, 0, 7, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[3].item = item2->uid;
			free(item);
		}
	...
	else if ( client_classes[player] == CLASS_SEXTON )
	{
		...
		// shard
		item = newItem(TOOL_CRYSTALSHARD, EXCELLENT, 0, 2, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		// purple hood
		item = newItem(HAT_FEZ, SERVICABLE, 1, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		{
			// chakram
			item = newItem(STEEL_CHAKRAM, SERVICABLE, 0, 2, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[1].item = item2->uid;
			free(item);

			// bread
			item = newItem(FOOD_BREAD, SERVICABLE, 0, 4, 0, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
			...
			item = newItem(SPELLBOOK_LOCKING, SERVICABLE, 1, 1, 6, true, nullptr);
			item2 = itemPickup(player, item);
			if ( players[player]->hotbar.useHotbarFaceMenu )
			{
				hotbar[8].item = item2->uid;
	...
	else if ( client_classes[player] == CLASS_NINJA )
	{
		...
		{
			// daggers
			item = newItem(IRON_DAGGER, WORN, 0, 6, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[1].item = item2->uid;
			free(item);

			// bear trap
			item = newItem(TOOL_BEARTRAP, SERVICABLE, 0, 2, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[2].item = item2->uid;
			free(item);
			...
			// invis potion
			item = newItem(POTION_INVISIBILITY, EXCELLENT, 0, 2, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[3].item = item2->uid;
			free(item);

			// teleport scroll
			item = newItem(SCROLL_TELEPORTATION, SERVICABLE, 0, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[5].item = item2->uid;
			free(item);
		}
	...
	else if ( client_classes[player] == CLASS_MONK )
	{
		...
		{
			// torch
			item = newItem(TOOL_TORCH, WORN, 0, 4, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[0].item = item2->uid;
			free(item);

			// light book
			item = newItem(SPELLBOOK_LIGHT, SERVICABLE, 0, 1, 7, true, nullptr);
			item2 = itemPickup(player, item);
			if ( players[player]->hotbar.useHotbarFaceMenu )
			{
				hotbar[8].item = item2->uid;
	...
	else if ( client_classes[player] == CLASS_CONJURER )
	{
		...
		// weapon
		item = newItem(MAGICSTAFF_LIGHTNING, EXCELLENT, 2, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
	...
	else if ( client_classes[player] == CLASS_MESMER )
	{
		...
		// ring
		item = newItem(RING_PROTECTION, EXCELLENT, 0, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		// weapon
		item = newItem(MAGICSTAFF_CHARM, WORN, curseItems ? -1 : 1, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
	...
	else if ( client_classes[player] == CLASS_BREWER )
	{
		...
		// backpack
		item = newItem(CLOAK_BACKPACK, EXCELLENT, curseItems ? -1 : 1, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		if ( isLocalPlayer )
		{
			...
			// firestorm
			item = newItem(POTION_FIRESTORM, EXCELLENT, 0, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[5].item = item2->uid;
			free(item);

			// acid
			item = newItem(POTION_ACID, EXCELLENT, 0, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
			...
			// juice
			item = newItem(POTION_JUICE, EXCELLENT, 0, 1, 3, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[7].item = item2->uid;
			free(item);
			...
			// blindness
			item = newItem(POTION_BLINDNESS, EXCELLENT, 0, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
	...
	else if ( client_classes[player] == CLASS_SHAMAN )
	{
		...
		item = newItem(MASK_SHAMAN, EXCELLENT, 0, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		// ring regen
		item = newItem(RING_REGENERATION, EXCELLENT, 0, 1, 0, true, NULL);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
	...
	else if ( client_classes[player] == CLASS_PUNISHER )
	{
		...
		item = newItem(TOOL_WHIP, EXCELLENT, curseItems ? -3 : 3, 1, 0, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		item = newItem(PUNISHER_HOOD, EXCELLENT, 0, 1, 1, true, nullptr);
		if ( isLocalPlayer )
		{
			item2 = itemPickup(player, item);
			useItem(item2, player);
		...
		if ( isLocalPlayer )
		{
			...
			item = newItem(RING_CONFLICT, WORN, curseItems ? -4 : 4, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[2].item = item2->uid;
			free(item);
		}
	...
	else if ( client_classes[player] == CLASS_HUNTER )
	{
		...
		if ( isLocalPlayer )
		{
			item = newItem(BOOMERANG, DECREPIT, curseItems ? -1 : 1, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[1].item = item2->uid;
			free(item);

			item = newItem(QUIVER_SILVER, SERVICABLE, 0, 80, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[2].item = item2->uid;
			free(item);

			item = newItem(QUIVER_LIGHTWEIGHT, SERVICABLE, 0, 80, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[3].item = item2->uid;
			free(item);

			item = newItem(QUIVER_HUNTING, SERVICABLE, 0, 40, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[4].item = item2->uid;
			free(item);

			item = newItem(SCROLL_CONJUREARROW, EXCELLENT, 0, 4, 0, true, nullptr);
			item2 = itemPickup(player, item);
			free(item);
			...
			item = newItem(TOOL_BLINDFOLD_TELEPATHY, EXCELLENT, curseItems ? -2 : 2, 1, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[5].item = item2->uid;
			free(item);
	...
	else if ( client_classes[player] == CLASS_MACHINIST )
	{
		...
		if ( isLocalPlayer )
		{
			item = newItem(TOOL_BEARTRAP, EXCELLENT, 0, 4, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[1].item = item2->uid;
			free(item);
			...
			item = newItem(TOOL_SLEEP_BOMB, EXCELLENT, 0, 2, 0, true, nullptr);
			item2 = itemPickup(player, item);
			hotbar[3].item = item2->uid;
			free(item);
			...
			{
				item = newItem(SCROLL_FIRE, SERVICABLE, 0, 2, 0, true, nullptr);
				item2 = itemPickup(player, item);
				free(item);
			}
		}
	...
	if (isLocalPlayer)
	{
		...
		else if (stats[player]->playerRace == RACE_INSECTOID && stats[player]->appearance == 0) //Moved insectoid up so Succubus and Incubus are side by side.
		{
			addSpell(SPELL_FLUTTER, player, true);
		...
		else if (stats[player]->playerRace == RACE_GOBLIN && stats[player]->appearance == 0)
		{
			stats[player]->STR += 2;
			stats[player]->INT -= 2;
		}
		else if (stats[player]->playerRace == RACE_SKELETON && stats[player]->appearance == 0)
		{
			stats[player]->STR += 1;
			stats[player]->INT += 1;
			stats[player]->CON += 1;
